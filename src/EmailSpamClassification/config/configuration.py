...
from EmailSpamClassification.entity.config_entity import DataIngestionConfig,DataValidationConfig
from EmailSpamClassification.entity.config_entity import DataTransformationConfig,ModelTrainerConfig
